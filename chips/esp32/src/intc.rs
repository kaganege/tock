...
use kernel::utilities::registers::{
    register_bitfields, register_structs, LocalRegisterCopy, ReadOnly, ReadWrite,
};
...
register_structs! {
    pub IntcRegisters {
        (0x000 => _reserved0),
        (0x01C => clk_en: ReadWrite<u32>),
        (0x020 => _reserved1),
        (0x0C0 => enable: ReadWrite<u32, INT::Register>),
        (0x0C4 => _reserved2),
        (0x0EC => status: [ReadOnly<u32>; 3]),
        (0x0F8 => _reserved3),
        (0x15C => gpio_interrupt_pro_map: ReadWrite<u32>),
        (0x160 => gpio_interrupt_pro_nmi_map: ReadWrite<u32>),
        (0x164 => _reserved4),
        (0x18C => uart0_intr_map: ReadWrite<u32>),
        (0x190 => _reserved5),
        // (0x194 => uart2_intr_map: ReadWrite<u32>),
        (0x1E4 => timg0_intr_map: ReadWrite<u32>),
        (0x1E8 => timg1_intr_map: ReadWrite<u32>),
        // (0x1E0 => _reserved3),
        ...
        // TODO: Find the fucking registers
        (0x1EC => @END),
    }
}
