...
pub struct Esp32<'a, I: InterruptService + 'a> {
...
pub struct Esp32DefaultPeripherals<'a> {
    pub uart0: crate::uart::Uart<'a>,
    pub timg0: timg::TimG<'a, crate::timg::Freq20MHz, true>,
    pub timg1: timg::TimG<'a, crate::timg::Freq20MHz, true>,
    pub gpio: crate::gpio::Port<'a>,
    pub rtc_cntl: crate::rtc_cntl::RtcCntl,
    pub sysreg: sysreg::SysReg,
    pub rng: rng::Rng<'a>,
}

impl<'a> Esp32DefaultPeripherals<'a> {
    pub fn new() -> Self {
        Self {
            ...
            gpio: crate::gpio::Port::new(),
            rtc_cntl: crate::rtc_cntl::RtcCntl::new(crate::rtc_cntl::RTC_CNTL_BASE),
...
impl<'a> InterruptService for Esp32DefaultPeripherals<'a> {
...
impl<'a, I: InterruptService + 'a> Esp32<'a, I> {
...
impl<'a, I: InterruptService + 'a> Chip for Esp32<'a, I> {
